...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            "Retrieval mode. Available options include: "
            "all_node, leaf_with_ancestors, table_hierarchy_leaf, table_inner_row, "
            "table_inner, combined_leaf_table  (combined_leaf_table = "
            "leaf_with_ancestors + table_inner_row + table_hierarchy_leaf)."
        ),
    )
